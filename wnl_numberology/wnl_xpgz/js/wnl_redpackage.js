...
(function (window) {
    ...
    root.shareRedPackage = function (params, cb) {
        if (Object.prototype.toString.call(params) === '[object Object]') {
            ...
            _shareArgs.url = 'https://mobile.51wnl.com/numberology/redpackagedev/redpackage.html?' + stringify(args);
            setElement(params);
            ...
            appendResource(function () {
                checkIsTips({
                    ...
                    if (data.data && isPay && isSharePlatform) {
                        ...
                        wx.ready(function () {
                            console.log('wxshare ready222')
                            wxShare(sharedatas, false);
