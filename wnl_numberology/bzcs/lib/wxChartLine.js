...
var config = {
  ...
  colors: ['#ffffff', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function drawPointShape(points, color, shape, context) {
  context.beginPath();
  context.setStrokeStyle("#f16300");
  context.setLineWidth(1);
  context.setFillStyle("#f16300");
...
function drawYAxisTitle(title, opts, config, context) {
  ...
  context.beginPath();
  context.setFontSize(config.fontSize);
  context.setFillStyle(opts.yAxis.titleFontColor || '#ffffff');
...
var ChartsLine = function ChartsLine(opts) {
...
ChartsLine.prototype.updateData = function () {
...
ChartsLine.prototype.stopAnimation = function () {
  this.animationInstance && this.animationInstance.stop();
};

ChartsLine.prototype.addEventListener = function (type, listener) {
  this.event.addEventListener(type, listener);
};

ChartsLine.prototype.getCurrentDataIndex = function (e) {
