...
! function(e, t) {
  'object' == typeof exports && 'object' == typeof module ? module.exports = t() :
    ...
    typeof exports ? exports.vConsole = t() : e.vConsole = t()
}(this, function() {
  return function(e) {
    function t(n) {
    ...
    p.addPlugin(h), p.VConsolePlugin = a['default'], t['default'] = p,
      e.exports = t['default']
  }, function(e, t, o) {
    'use strict';
        ...
        function e(e, t) {
          for (var o = 0; o < t.length; o++) {
            ...
            n.enumerable = n.enumerable || !1, n.configurable = !0,
              'value' in n && (n.writable = !0), Object.defineProperty(
                e, n.key, n)
          }
        }
    ...
    var f = o(10),
      ...
      k = function() {
        function e() {
          i(this, e);
          var t = this;
          this.version = c['default'].version, this.html = p['default'],
            this.$dom = null, this.activedTab = '', this.tabList = [],
            this.pluginList = {}, this.isReady = !1, this.switchPos = {
              x: 10,
              y: 10,
              startX: 0,
              startY: 0,
          ...
          void 0 !== document ? 'complete' == document.readyState ? o() :
            v['default'].bind(window, 'load', o) : ! function() {
              var e = void 0,
                t = function n() {
                  document && 'complete' == document.readyState ? (e &&
                    clearTimeout(e), o()) : e = setTimeout(n, 1)
                };
              e = setTimeout(t, 1)
            }()
        }
        return r(e, [{
          ...
          value: function() {
            ...
            if (!v['default'].one(e)) {
              ...
              t.innerHTML = this.html, document.documentElement
                .insertAdjacentElement('beforeend', t.children[
                  0])
            }
            ...
            (n || l) && (n + o.offsetWidth > document.documentElement
              .offsetWidth && (n = document.documentElement.offsetWidth -
                o.offsetWidth), l + o.offsetHeight > document.documentElement
              .offsetHeight && (l = document.documentElement.offsetHeight -
                o.offsetHeight), 0 > n && (n = 0), 0 > l && (l =
                0), this.switchPos.x = n, this.switchPos.y = l,
              v['default'].one('.vc-switch').style.right = n +
              'px', v['default'].one('.vc-switch').style.bottom =
              l + 'px'), v['default'].one('.vc-mask', this.$dom)
              .style.display = 'none'
          }
        }, {
          key: '_mockTap',
          value: function() {
            ...
            this.$dom.addEventListener('touchstart', function(e) {
              if (void 0 === o) {
                ...
                n = t.pageX, l = t.pageY, o = e.timeStamp,
                  r = e.target.nodeType === Node.TEXT_NODE ?
                  e.target.parentNode : e.target
              }
            }, !1), this.$dom.addEventListener('touchmove',
              function(e) {
                var o = e.changedTouches[0];
                (Math.abs(o.pageX - n) > t || Math.abs(o.pageY -
                  l) > t) && (i = !0)
              }), this.$dom.addEventListener('touchend',
              function(t) {
                if (i === !1 && t.timeStamp - o < e && null !=
                  r) {
                  ...
                  c.initMouseEvent('click', !0, !0, window, 1,
                      a.screenX, a.screenY, a.clientX, a.clientY, !
                      1, !1, !1, !1, 0, null), c.forwardedTouchEvent = !
                    0, c.initEvent('click', !0, !0), r.dispatchEvent(
                      c)
                }
                o = void 0, i = !1, r = null
              }, !1)
          ...
          value: function() {
            ...
            v['default'].bind(t, 'touchstart', function(t) {
              e.switchPos.startX = t.touches[0].pageX, e.switchPos
                .startY = t.touches[0].pageY
            }), v['default'].bind(t, 'touchend', function(t) {
              e.switchPos.x = e.switchPos.endX, e.switchPos
                .y = e.switchPos.endY, e.switchPos.startX =
                0, e.switchPos.startY = 0, e.switchPos.endX =
                0, e.switchPos.endY = 0, d.setStorage(
                  'switch_x', e.switchPos.x), d.setStorage(
                  'switch_y', e.switchPos.y)
              ...
              if (o.touches.length > 0) {
                var n = o.touches[0].pageX - e.switchPos.startX,
                  ...
                  i = e.switchPos.x - n,
                  r = e.switchPos.y - l;
                i + t.offsetWidth > document.documentElement
                  .offsetWidth && (i = document.documentElement
                    .offsetWidth - t.offsetWidth), r + t.offsetHeight >
                  document.documentElement.offsetHeight &&
                  (r = document.documentElement.offsetHeight -
                    t.offsetHeight), 0 > i && (i = 0), 0 >
                  r && (r = 0), t.style.right = i + 'px', t
                  .style.bottom = r + 'px', e.switchPos.endX =
                  i, e.switchPos.endY = r, o.preventDefault()
              }
            }), v['default'].bind(v['default'].one(
              '.vc-switch', e.$dom), 'click', function() {
              e.show()
            }), v['default'].bind(v['default'].one('.vc-hide',
              e.$dom), 'click', function() {
              e.hide()
            }), v['default'].bind(v['default'].one('.vc-mask',
              e.$dom), 'click', function(t) {
              return t.target != v['default'].one(
                '.vc-mask') ? !1 : void e.hide()
            }), v['default'].delegate(v['default'].one(
                '.vc-tabbar', e.$dom), 'click', '.vc-tab',
              function(t) {
              ...
              function(t) {
                return t.target != v['default'].one(
                  '.vc-panel') ? !1 : void(v['default'].hasClass(
                  e.$dom, 'vc-toggle') || (t.target.style
                  .display = 'none'))
              });
            ...
            v['default'].bind(o, 'touchstart', function(e) {
              var t = o.scrollTop,
                l = o.scrollHeight,
                i = t + o.offsetHeight;
              0 === t ? (o.scrollTop = 1, 0 === o.scrollTop &&
                  (v['default'].hasClass(e.target,
                    'vc-cmd-input') || (n = !0))) : i === l &&
                (o.scrollTop = t - 1, o.scrollTop === t &&
                  (v['default'].hasClass(e.target,
                    'vc-cmd-input') || (n = !0)))
          ...
          value: function() {
            this.isReady = !0;
            for (var e in this.pluginList) this._initPlugin(
              this.pluginList[e]);
            this.tabList.length > 0 && this.showTab(this.tabList[
              0])
          }
        }, {
          key: '_initPlugin',
          value: function(e) {
            var t = this;
            e.trigger('init'), e.trigger('renderTab', function(
              o) {
              t.tabList.push(e.id);
              ...
              v['default'].one('.vc-tabbar', t.$dom).insertAdjacentElement(
                'beforeend', n);
              var l = v['default'].render(m['default'], {
                id: e.id
              });
              o && (d.isString(o) ? l.innerHTML += o : d.isFunction(
                o.appendTo) ? o.appendTo(l) : d.isElement(
                o) && l.insertAdjacentElement(
                'beforeend', o)), v['default'].one(
                '.vc-content', t.$dom).insertAdjacentElement(
                'beforeend', l)
            }), e.trigger('addTopBar', function(o) {
              if (o)
                for (var n = v['default'].one('.vc-topbar',
                    t.$dom), l = function(t) {
                    var l = o[t],
                    ...
                    if (l.data)
                      for (var r in l.data) i.dataset[r] =
                        l.data[r];
                    d.isFunction(l.onClick) && v[
                      'default'].bind(i, 'click',
                      function(t) {
                        var o = l.onClick.call(i);
                        o === !1 || (v['default'].removeClass(
                          v['default'].all(
                            '.vc-topbar-' + e.id),
                          'vc-actived'), v[
                          'default'].addClass(i,
              ...
              if (t)
                for (var o = v['default'].one(
                    '.vc-tool-last'), n = function(n) {
                    var l = t[n],
                      i = v['default'].render(x['default'], {
                        name: l.name || 'Undefined',
                        pluginID: e.id
                      });
                    1 == l.global && v['default'].addClass(
                      i, 'vc-global-tool'), d.isFunction(
                      l.onClick) && v['default'].bind(i,
                      'click',
                      function(e) {
                        l.onClick.call(i)
                      }), o.parentNode.insertBefore(i,
                      o)
          ...
          value: function(e) {
            for (var t in this.pluginList) this.pluginList[t].trigger(
              e)
          }
        }, {
          ...
          key: 'addPlugin',
          value: function(e) {
            return void 0 !== this.pluginList[e.id] ? (console.warn(
              'Plugin ' + e.id + ' has already been added.'
            ), !1) : (this.pluginList[e.id] = e, this.isReady &&
              (this._initPlugin(e), 1 == this.tabList.length &&
                this.showTab(this.tabList[0])), !0)
          }
        }, {
          key: 'removePlugin',
          value: function(e) {
            ...
            if (void 0 === t) return console.warn('Plugin ' + e +
              ' does not exist.'), !1;
            if (t.trigger('remove'), this.isReady) {
              var o = v['default'].one('#__vc_tab_' + e);
              o && o.parentNode.removeChild(o);
              for (var n = v['default'].all('.vc-topbar-' + e,
                  this.$dom), l = 0; l < n.length; l++) n[l].parentNode
                .removeChild(n[l]);
              var i = v['default'].one('#__vc_log_' + e);
              i && i.parentNode.removeChild(i);
              for (var r = v['default'].all('.vc-tool-' + e,
                  this.$dom), a = 0; a < r.length; a++) r[a].parentNode
                .removeChild(r[a])
            }
            ...
            return this.activedTab == e && this.tabList.length >
              0 && this.showTab(this.tabList[0]), !0
          }
        }, {
          key: 'show',
          value: function() {
            ...
            t.style.display = 'block', setTimeout(function() {
              v['default'].addClass(e.$dom, 'vc-toggle'), e
                ._triggerPluginsEvent('showConsole');
          ...
          value: function(e) {
            ...
            v['default'].removeClass(v['default'].all('.vc-tab',
              this.$dom), 'vc-actived'), v['default'].addClass(
              v['default'].one('#__vc_tab_' + e),
              'vc-actived'), v['default'].removeClass(v[
                'default'].all('.vc-logbox', this.$dom),
              'vc-actived'), v['default'].addClass(t,
              'vc-actived');
            var o = v['default'].all('.vc-topbar-' + e, this.$dom);
            v['default'].removeClass(v['default'].all(
                '.vc-toptab', this.$dom), 'vc-toggle'), v[
                'default'].addClass(o, 'vc-toggle'), o.length >
              0 ? v['default'].addClass(v['default'].one(
                '.vc-content', this.$dom), 'vc-has-topbar') : v[
                'default'].removeClass(v['default'].one(
                '.vc-content', this.$dom), 'vc-has-topbar'), v[
                'default'].removeClass(v['default'].all(
                '.vc-tool', this.$dom), 'vc-toggle'), v[
                'default'].addClass(v['default'].all(
                '.vc-tool-' + e, this.$dom), 'vc-toggle'), this
              ._triggerPluginEvent(this.activedTab, 'hide'),
              this.activedTab = e, this._triggerPluginEvent(
                this.activedTab, 'show')
          }
        }]), e
      }();
    ...
    function o(e) {
      var t = e > 0 ? new Date(e) : new Date,
        ...
        n = t.getMonth() < 9 ? '0' + (t.getMonth() + 1) : t.getMonth() +
        1,
        l = t.getFullYear(),
    ...
    function d(e) {
      return !('[object Object]' != Object.prototype.toString.call(e) &&
        (n(e) || l(e) || r(e) || i(e) || c(e) || u(e) || a(e) || s(e))
      )
    }
    ...
    function v(e) {
      return 'object' === ('undefined' == typeof HTMLElement ?
          'undefined' : y(HTMLElement)) ? e instanceof HTMLElement : e &&
        'object' === ('undefined' == typeof e ? 'undefined' : y(e)) &&
        null !== e && 1 === e.nodeType && 'string' == typeof e.nodeName
    }

    function f(e) {
      return document.createElement('a').appendChild(document.createTextNode(
      ...
      function o(e) {
        if (d(e)) {
          ...
          for (var g = 0; g < b.length; g++) {
            var h = b[g];
            e.hasOwnProperty && !e.hasOwnProperty(h) || (v += h + ': ',
              o(e[h], e), g < b.length - 1 && (v += ', '))
          }
          f--, v += '}', p.pop()
        } else if (i(e)) {
          ...
          for (var m = 0; m < e.length; m++) o(e[m], e), m < e.length -
            1 && (v += ', ');
          f--, v += ']', p.pop()
        } else v += l(e) ? '"' + e + '"' : n(e) ? e : r(e) ? e : c(e) ?
          'null' : a(e) ? 'undefined' : u(e) ? 'function()' : s(e) ?
          'symbol' : 'unknown'
      }
      var v = '',
        f = 0,
    ...
    function b(e) {
      if (!d(e) && !i(e)) return [];
      var t = ['toString', 'toLocaleString', 'valueOf',
    ...
    function h(e, t) {
      window.localStorage && (e = 'vConsole_' + e, localStorage.setItem(
        e, t))
    }

    function m(e) {
      return window.localStorage ? (e = 'vConsole_' + e, localStorage.getItem(
        e)) : void 0
    }
    Object.defineProperty(t, '__esModule', {
      value: !0
    ...
    t.getDate = o, t.isNumber = n, t.isString = l, t.isArray = i, t.isBoolean =
      r, t.isUndefined = a, t.isNull = c, t.isSymbol = s, t.isObject =
      d, t.isFunction = u, t.isElement = v, t.htmlEncode = f, t.JSONStringify =
      p, t.getObjAllKeys = b, t.getObjName = g, t.setStorage = h, t.getStorage =
      m
  }, function(e, t, o) {
    'use strict';
    ...
    a.one = function(e, t) {
      ...
      var o = void 0,
        n = [];
      return o = t ? t.querySelectorAll(e) : document.querySelectorAll(
          e), o && o.length > 0 && (n = Array.prototype.slice.call(o)),
        n
      ...
      if (e) {
        ...
        for (var i = 0; i < e.length; i++) e[i].addEventListener(t, o,
          n)
      }
    ...
    }, a.render = r['default'], t['default'] = a, e.exports = t[
      'default']
  }, function(e, t) {
    'use strict';
    ...
    function o(e, t, o) {
      ...
      for (e = e.replace(/(\{\{ ?switch(.+?)\}\})[\r\n\t ]+\{\{/g,
          '$1{{'), e = e.replace(/^\n/, '').replace(/\n/g, '\\\n'); r =
        n.exec(e);) a(e.slice(i, r.index), !1), a(r[1], !0), i = r.index +
        r[0].length;
      a(e.substr(i, e.length - i), !1), l += 'return arr.join("");', l =
        'with (this) {\n' + l + '\n}';
    ...
    e.exports = function() {
      ...
      return e.toString = function() {
        for (var e = [], t = 0; t < this.length; t++) {
          var o = this[t];
          o[2] ? e.push('@media ' + o[2] + '{' + o[1] + '}') : e.push(
            o[1])
        }
        return e.join('')
      }, e.i = function(t, o) {
        ...
        for (l = 0; l < t.length; l++) {
          var r = t[l];
          'number' == typeof r[0] && n[r[0]] || (o && !r[2] ? r[2] =
            o : o && (r[2] = '(' + r[2] + ') and (' + o + ')'), e
            .push(r))
        }
      }, e
    ...
    function n(e, t) {
      for (var o = 0; o < e.length; o++) {
        ...
        if (l) {
          ...
          for (var r = [], i = 0; i < n.parts.length; i++) r.push(s(n.parts[
            i], t));
          f[n.id] = {
            id: n.id,
            refs: 1,
    ...
    function i(e, t) {
      var o = g(),
        n = y[y.length - 1];
      if ('top' === e.insertAt) n ? n.nextSibling ? o.insertBefore(t, n
          .nextSibling) : o.appendChild(t) : o.insertBefore(t, o.firstChild),
        y.push(t);
      else {
    ...
    function s(e, t) {
      ...
      if (t.singleton) {
        var i = m++;
        o = h || (h = a(t)), n = d.bind(null, o, i, !1), l = d.bind(
          null, o, i, !0)
      } else e.sourceMap && 'function' == typeof URL && 'function' ==
        typeof URL.createObjectURL && 'function' == typeof URL.revokeObjectURL &&
        'function' == typeof Blob && 'function' == typeof btoa ? (o = c(
          t), n = v.bind(null, o), l = function() {
      ...
      return n(e),
        function(t) {
          if (t) {
            if (t.css === e.css && t.media === e.media && t.sourceMap ===
              e.sourceMap) return;
            n(e = t)
          } else l()
        }
    ...
    function d(e, t, o, n) {
      ...
      if (e.styleSheet) e.styleSheet.cssText = _(t, l);
        ...
        var i = document.createTextNode(l),
          r = e.childNodes;
        r[t] && e.removeChild(r[t]), r.length ? e.insertBefore(i, r[t]) :
          e.appendChild(i)
      }
    }
    ...
    function u(e, t) {
      var o = t.css,
        n = t.media;
      if (n && e.setAttribute('media', n), e.styleSheet) e.styleSheet.cssText =
        o;
      else {
    ...
    e.exports = function(e, t) {
      t = t || {}, 'undefined' == typeof t.singleton && (t.singleton =
        b()), 'undefined' == typeof t.insertAt && (t.insertAt =
        'bottom');
      var o = l(e);
      return n(o, t),
        function(e) {
    ...
    var n = function() {
      ...
      l = function() {
        ...
        return n(e, [{
          ...
          key: 'trigger',
          value: function(e, t) {
            if ('function' == typeof this.eventList[e]) this.eventList[
              e].call(this, t);
            else {
              var o = 'on' + e.charAt(0).toUpperCase() + e.slice(
                1);
              'function' == typeof this[o] && this[o].call(this,
                t)
            }
            return this
          }
      ...
      VConsoleDefaultTab = function(_VConsoleLogTab) {
        function VConsoleDefaultTab() {
          ...
          for (var t = arguments.length, o = Array(t), n = 0; t > n; n++)
            o[n] = arguments[n];
          var l = _possibleConstructorReturn(this, (e = Object.getPrototypeOf(
            VConsoleDefaultTab)).call.apply(e, [this].concat(o)));
          return l.tplTabbox = _tabbox_default2['default'], l.windowOnError =
            null, l
        }
        return _inherits(VConsoleDefaultTab, _VConsoleLogTab),
          _createClass(VConsoleDefaultTab, [{
            ...
            value: function() {
              var e = this;
              _get(Object.getPrototypeOf(VConsoleDefaultTab.prototype),
                  'onReady', this).call(this), _query2['default']
                .bind(_query2['default'].one('.vc-cmd', this.$tabbox),
                  'submit',
                  function(t) {
                    t.preventDefault();
                    var o = _query2['default'].one(
                        '.vc-cmd-input', t.target),
                      n = o.value;
            ...
            value: function() {
              _get(Object.getPrototypeOf(VConsoleDefaultTab.prototype),
                'mockConsole', this).call(this);
              var e = this;
              tool.isFunction(window.onerror) && (this.windowOnError =
                window.onerror), window.onerror = function(t, o,
                n, l, i) {
                var r = t;
                o && (r += '\n' + o.replace(location.origin, '')), (
                    n || l) && (r += ':' + n + ':' + l), e.printLog({
                    logType: 'error',
                    logs: [r],
                    noOrigin: !0
                  }), tool.isFunction(e.windowOnError) && e.windowOnError
                  .call(window, t, o, n, l, i)
              }
            }
          }, {
            key: 'evalCommand',
            value: function evalCommand(cmd) {
              this.printLog({
                logType: 'log',
                content: _query2['default'].render(
                  _item_code2['default'], {
                    content: cmd,
                    type: 'input'
                  }),
              ...
              var result = eval(cmd),
                $content = void 0;
              tool.isArray(result) || tool.isObject(result) ?
                $content = this.getFoldedLine(result) : (tool.isNull(
                    result) ? result = 'null' : tool.isUndefined(
                    result) ? result = 'undefined' : tool.isFunction(
                    result) ? result = 'function()' : tool.isString(
    ...
    exports['default'] = VConsoleDefaultTab, module.exports = exports[
      'default']
  }, function(e, t, o) {
    'use strict';
    ...
    var c = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ?
      ...
      x = function(e) {
        function t() {
          var e;
          i(this, t);
          for (var o = arguments.length, n = Array(o), l = 0; o > l; l++)
            n[l] = arguments[l];
          var a = r(this, (e = Object.getPrototypeOf(t)).call.apply(e, [
            this
          ].concat(n)));
          return a.tplTabbox = '', a.allowUnformattedLog = !0, a.isReady = !
            1, a.isShow = !1, a.$tabbox = null, a.console = {}, a.logList = [],
            a.isInBottom = !0, a.mockConsole(), a
        }
        return a(t, e), s(t, [{
          key: 'onInit',
          value: function() {
          ...
          key: 'onAddTopBar',
          value: function(e) {
            for (var t = this, o = ['All', 'Log', 'Info',
                'Warn', 'Error'
              ], n = [], l = 0; l < o.length; l++) n.push({
              name: o[l],
              data: {
              ...
              className: '',
              onClick: function() {
                return f['default'].hasClass(this,
                  'vc-actived') ? !1 : void t.showLogType(
          ...
          value: function() {
            ...
            f['default'].bind(t, 'click', function(o) {
              if (o.preventDefault(), f['default'].hasClass(
                  this, 'vc-actived')) return !1;
              f['default'].removeClass(t, 'vc-actived'), f[
                'default'].addClass(this, 'vc-actived');
              var n = this.dataset.type,
                l = f['default'].one('.vc-log', e.$tabbox);
              f['default'].removeClass(l,
                  'vc-log-partly-log'), f['default'].removeClass(
                  l, 'vc-log-partly-info'), f['default'].removeClass(
                  l, 'vc-log-partly-warn'), f['default'].removeClass(
                  l, 'vc-log-partly-error'), 'all' == n ? f[
                  'default'].removeClass(l, 'vc-log-partly') :
                (f['default'].addClass(l, 'vc-log-partly'),
                  f['default'].addClass(l, 'vc-log-partly-' +
                    n))
            });
            var o = f['default'].one('.vc-content');
            f['default'].bind(o, 'scroll', function(t) {
              e.isShow && (o.scrollTop + o.offsetHeight >=
                o.scrollHeight ? e.isInBottom = !0 : e.isInBottom = !
                1)
            });
            for (var n = 0; n < e.logList.length; n++) e.printLog(
              e.logList[n]);
            e.logList = []
          }
        }, {
          key: 'onRemove',
          value: function() {
            window.console.log = this.console.log, window.console
              .info = this.console.info, window.console.warn =
              this.console.warn, window.console.debug = this.console
              .debug, window.console.error = this.console.error,
              this.console = {}
          }
        }, {
          key: 'onShow',
          ...
          value: function(e) {
            ...
            f['default'].removeClass(t, 'vc-log-partly-log'), f[
              ...
              'all' == e ? f['default'].removeClass(t,
                'vc-log-partly') : (f['default'].addClass(t,
                'vc-log-partly'), f['default'].addClass(t,
                'vc-log-partly-' + e))
          }
        }, {
          ...
          value: function() {
            var e = this;
            window.console ? (this.console.log = window.console
                .log, this.console.info = window.console.info,
                this.console.warn = window.console.warn, this.console
                .debug = window.console.debug, this.console.error =
                window.console.error) : window.console = {},
          ...
          value: function(e) {
            ...
            if (t.length || e.content) {
              ...
              if (l ? o = l == this.id : 0 == this.allowUnformattedLog &&
                (o = !1), !o) return void(e.noOrigin || this.printOriginLog(
                e));
              ...
              for (var a = f['default'].render(h['default'], {
                  ...
                  meta: e.meta,
                  style: e.style || ''
                }), s = f['default'].one('.vc-item-content',
                  a), d = 0; d < t.length; d++) {
                var v = void 0;
                try {
                  if ('' === t[d]) continue;
                  v = u.isFunction(t[d]) ? '<span> ' + t[d].toString() +
                    '</span>' : u.isObject(t[d]) || u.isArray(t[
                      d]) ? this.getFoldedLine(t[d]) :
                    '<span> ' + u.htmlEncode(t[d]).replace(
                      /\n/g, '<br/>') + '</span>'
                } catch (p) {
                  v = '<span> [' + c(t[d]) + ']</span>'
                }
                v && ('string' == typeof v ? s.insertAdjacentHTML(
                  'beforeend', v) : s.insertAdjacentElement(
                  'beforeend', v))
              }
              u.isObject(e.content) && s.insertAdjacentElement(
                  'beforeend', e.content), f['default'].one(
                  '.vc-log', this.$tabbox).insertAdjacentElement(
                  'beforeend', a), this.isInBottom && this.scrollToBottom(),
          ...
          value: function(e, t) {
            ...
            if (!t) {
              var n = u.JSONStringify(e),
                l = n.substr(0, 26);
              t = u.getObjName(e), n.length > 26 && (l += '...'),
                t += ' ' + l
            }
            ...
            return f['default'].bind(f['default'].one(
              '.vc-fold-outer', i), 'click', function(t) {
              t.preventDefault(), t.stopPropagation(), f[
                'default'].hasClass(i, 'vc-toggle') ? (f[
                  'default'].removeClass(i, 'vc-toggle'),
                f['default'].removeClass(f['default'].one(
                  '.vc-fold-inner', i), 'vc-toggle'), f[
                  'default'].removeClass(f['default'].one(
                  '.vc-fold-outer', i), 'vc-toggle')) : (
                f['default'].addClass(i, 'vc-toggle'), f[
                  'default'].addClass(f['default'].one(
                  '.vc-fold-inner', i), 'vc-toggle'), f[
                  'default'].addClass(f['default'].one(
                  '.vc-fold-outer', i), 'vc-toggle'));
              var n = f['default'].one('.vc-fold-inner', i);
              if (0 == n.children.length && e) {
                for (var l = u.getObjAllKeys(e), r = 0; r <
                  l.length; r++) {
                  var a = e[l[r]],
                    c = 'undefined',
                    s = '';
                  u.isString(a) ? (c = 'string', a = '"' +
                      a + '"') : u.isNumber(a) ? c =
                    'number' : u.isBoolean(a) ? c =
                    'boolean' : u.isNull(a) ? (c = 'null',
                      a = 'null') : u.isUndefined(a) ? (c =
                      'undefined', a = 'undefined') : u.isFunction(
                      a) ? (c = 'function', a =
                      'function()') : u.isSymbol(a) && (c =
                      'symbol');
                  var d = void 0;
                  if (u.isArray(a)) {
                    var v = u.getObjName(a) + '[' + a.length +
                      ']';
                    d = o.getFoldedLine(a, f['default'].render(
                      w['default'], {
                        key: l[r],
                        keyType: s,
                        value: v,
                    ...
                    e.hasOwnProperty && !e.hasOwnProperty(l[
                      r]) && (s = 'private');
                    var b = {
                      lineType: 'kv',
                      key: u.htmlEncode(l[r]),
                ...
                if (u.isObject(e)) {
                  var g = e.__proto__,
                    h = void 0;
                  h = u.isObject(g) ? o.getFoldedLine(g, f[
                    'default'].render(w['default'], {
                    key: '__proto__',
                    keyType: 'private',
                    value: u.getObjName(g),
                    valueType: 'object'
                  }, !0)) : f['default'].render(w[
                    'default'], {
                    key: '__proto__',
                    keyType: 'private',
                    value: 'null',
    ...
    e.exports =
      '<div class=vc-fold> {{if (lineType == \'obj\')}} <i class=vc-fold-outer>{{outer}}</i> <div class=vc-fold-inner></div> {{else if (lineType == \'value\')}} <i class=vc-code-{{valueType}}>{{value}}</i> {{else if (lineType == \'kv\')}} <i class="vc-code-key{{if (keyType)}} vc-code-{{keyType}}-key{{/if}}">{{key}}</i>: <i class=vc-code-{{valueType}}>{{value}}</i> {{/if}} </div>'
  }, function(e, t) {
    e.exports =
    ...
    var c = function() {
      ...
      b = function(e) {
        function t() {
          ...
          return a.tplTabbox = p['default'], a.allowUnformattedLog = !1,
            a
        }
        return a(t, e), c(t, [{
          key: 'onInit',
          value: function() {
            s(Object.getPrototypeOf(t.prototype), 'onInit',
              this).call(this), this.printSystemInfo()
          }
        }, {
          key: 'printSystemInfo',
          value: function() {
            ...
            t = 'Unknown', i ? t = 'Android ' + i[2] : l ? t =
              'iPhone, iOS ' + l[2].replace(/_/g, '.') : n ? t =
              'iPad, iOS ' + n[2].replace(/_/g, '.') : o && (t =
                'iPod, iOS ' + o[2].replace(/_/g, '.'));
            var r = t,
              a = e.match(/MicroMessenger\/([\d\.]+)/i);
            t = 'Unknown', a && a[1] ? (t = a[1], r +=
                ', WeChat ' + t, console.info('[system]',
                  'System:', r)) : console.info('[system]',
                'System:', r), t = 'Unknown', t = 'https:' ==
              location.protocol ? 'HTTPS' : 'http:' == location
              .protocol ? 'HTTP' : location.protocol.replace(
                ':', ''), r = t;
            var c = e.toLowerCase().match(/ nettype\/([^ ]+)/g);
            t = 'Unknown', c && c[0] ? (c = c[0].split('/'), t =
              c[1], r += ', ' + t, console.info('[system]',
                'Network:', r)) : console.info('[system]',
              'Protocol:', r), console.info('[system]', 'UA:',
              e), setTimeout(function() {
              var e = window.performance || window.msPerformance ||
                window.webkitPerformance;
              if (e && e.timing) {
                var t = e.timing;
                t.navigationStart && console.info(
                    '[system]', 'navigationStart:', t.navigationStart
                  ), t.navigationStart && t.domainLookupStart &&
                  console.info('[system]', 'navigation:', t
                    .domainLookupStart - t.navigationStart +
                    'ms'), t.domainLookupEnd && t.domainLookupStart &&
                  console.info('[system]', 'dns:', t.domainLookupEnd -
                    t.domainLookupStart + 'ms'), t.connectEnd &&
                  t.connectStart && (t.connectEnd && t.secureConnectionStart ?
                    console.info('[system]', 'tcp (ssl):',
                      t.connectEnd - t.connectStart +
                      'ms (' + (t.connectEnd - t.secureConnectionStart) +
                      'ms)') : console.info('[system]',
                      'tcp:', t.connectEnd - t.connectStart +
                      'ms')), t.responseStart && t.requestStart &&
                  console.info('[system]', 'request:', t.responseStart -
                    t.requestStart + 'ms'), t.responseEnd &&
                  t.responseStart && console.info(
                    '[system]', 'response:', t.responseEnd -
                    t.responseStart + 'ms'), t.domComplete &&
                  t.domLoading && (t.domContentLoadedEventStart &&
                    t.domLoading ? console.info('[system]',
                      'domComplete (domLoaded):', t.domComplete -
                      t.domLoading + 'ms (' + (t.domContentLoadedEventStart -
                        t.domLoading) + 'ms)') : console.info(
                      '[system]', 'domComplete:', t.domComplete -
                      t.domLoading + 'ms')), t.loadEventEnd &&
                  t.loadEventStart && console.info(
                    '[system]', 'loadEvent:', t.loadEventEnd -
                    t.loadEventStart + 'ms'), t.navigationStart &&
                  t.loadEventEnd && console.info('[system]',
                    'total (DOM):', t.loadEventEnd - t.navigationStart +
    ...
    var c = function() {
      ...
      w = function(e) {
        function t() {
          ...
          return a.$tabbox = d['default'].render(g['default'], {}), a.$header =
            null, a.reqList = {}, a.domList = {}, a.isReady = !1, a.isShow = !
            1, a.isInBottom = !0, a._open = void 0, a._send = void 0, a
            .mockAjax(), a
        }
        return a(t, e), c(t, [{
          key: 'onRenderTab',
          ...
          value: function() {
            var e = this;
            e.isReady = !0, this.renderHeader(), d['default'].delegate(
              d['default'].one('.vc-log', this.$tabbox),
              'click', '.vc-group-preview',
              function(e) {
                var t = this.parentNode;
                d['default'].hasClass(t, 'vc-actived') ? d[
                    'default'].removeClass(t, 'vc-actived') :
                  d['default'].addClass(t, 'vc-actived'), e.preventDefault()
              });
            var t = d['default'].one('.vc-content');
            d['default'].bind(t, 'scroll', function(o) {
              e.isShow && (t.scrollTop + t.offsetHeight >=
                t.scrollHeight ? e.isInBottom = !0 : e.isInBottom = !
                1)
            });
          ...
          value: function() {
            window.XMLHttpRequest && (window.XMLHttpRequest.prototype
              .open = this._open, window.XMLHttpRequest.prototype
              .send = this._send, this._open = void 0, this._send =
              void 0)
          }
        }, {
          key: 'onShow',
          ...
          value: function() {
            this.reqList = {};
            for (var e in this.domList) this.domList[e].remove(),
          ...
          value: function() {
            ...
            this.$header ? this.$header.parentNode.replaceChild(
              t, this.$header) : o.parentNode.insertBefore(t,
              o), this.$header = t
          }
        }, {
          key: 'updateRequest',
          value: function(e, t) {
            ...
            if (this.reqList[e] = n, this.isReady) {
              ...
              n.readyState <= 1 ? i.status = 'Pending' : n.readyState <
                4 && (i.status = 'Loading');
              var r = d['default'].render(_['default'], i),
                a = this.domList[e];
              n.status >= 400 && d['default'].addClass(d[
                    'default'].one('.vc-group-preview', r),
                  'vc-table-row-error'), a ? a.parentNode.replaceChild(
                  r, a) : d['default'].one('.vc-log', this.$tabbox)
                .insertAdjacentElement('beforeend', r), this.domList[
                  e] = r;
              var c = Object.keys(this.reqList).length;
              c != o && this.renderHeader(), this.isInBottom &&
                this.scrollToBottom()
            }
          }
        }, {
          ...
          value: function() {
            ...
            if (e) {
              ...
              t._open = o, t._send = n, window.XMLHttpRequest.prototype
                .open = function() {
                  var e = this,
                  ...
                  return e.onreadystatechange = function() {
                    var o = t.reqList[i] || {};
                    if (o.url = l, o.readyState = e.readyState,
                      0 == e.readyState) o.startTime = +new Date;
                    else if (1 == e.readyState) o.startTime = +
                      new Date;
                    else if (2 == e.readyState) {
                      o.header = {};
                      for (var n = e.getAllResponseHeaders() ||
                          '', a = n.split('\n'), c = 0; c < a
                        .length; c++) {
                        var s = a[c];
                        if (s) {
                    ...
                    } else 3 == e.readyState || 4 == e.readyState &&
                      (o.status = e.status, o.endTime = +new Date,
                        o.costTime = o.endTime - (o.startTime ||
                          o.endTime), o.response = e.response
                      );
                    return e._noVConsole || t.updateRequest(i,
