$(function () {
    ...
    var purposeId="B3";
    var source="紫微精装";
    var goodsId="CFE870D40C664A11BCA62A268DC2EF7D";
    ...
    $(".confirmBtn").click(function () {
        ...
        localStorage.setItem("mingli_zwjz_data",JSON.stringify(localObj));
...
function userinfocallback(result) {
    ...
    if ("mingli_zwjz_data" in localStorage) {
        originalAllObj.zwjz = JSON.parse(localStorage.getItem("mingli_zwjz_data"));
    }
    var originalObj = originalAllObj.zwjz || originalAllObj.native_jryc || originalAllObj.native_usercenter;
