...
(function (global) {
    ...
    if (!isWnl) {
        ...
        var wnl_loc = JSON.parse(localStorage.getItem('wnl_gycard_local'));
    ...
    if (!browser.isWx() && (!browser.isWnl() || (userId === '' && deviceId === ''))) {
        if (localStorage.getItem('wnl_gycard_guid')) {
            window.userId = localStorage.getItem('wnl_gycard_guid');
            window.deviceId = localStorage.getItem('wnl_gycard_guid');
            historyBtn.style.display = 'block';
        } else {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    localStorage.setItem('wnl_gycard_guid', userId);
        ...
        if (wnl_loc && wnl_loc.wnlUserId) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    window.localStorage.setItem('wnl_gycard_local', JSON.stringify({
                        wnlUserId: userId,
                        openid: openid,
                        unionid: unionid
                    }));
