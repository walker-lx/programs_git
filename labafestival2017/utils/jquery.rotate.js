(function (n) {
    for (var r, t, f = document.getElementsByTagName("head")[0].style, u = "transformProperty WebkitTransform OTransform msTransform MozTransform".split(" "), i = 0; i < u.length; i++) f[u[i]] !== undefined && (t = u[i]);
    r = eval('"v"=="\v"');
    jQuery.fn.extend({
        rotate: function (t) {
            var u, r, f, i, e, o;
    ...
    Wilq32.PhotoEffect = function () {
        return t ? function (n, t) {
            ...
            if (this._img = n, this._rootObj = document.createElement("span"), this._rootObj.style.display = "inline-block", this._rootObj.Wilq32 = {
                    PhotoEffect: this
                }, n.parentNode.insertBefore(this._rootObj, n), n.complete) this._Loader(t);
            else {
                var i = this;
    ...
    Wilq32.PhotoEffect.prototype = {
        _setupParameters: function (n) {
            ...
            this._parameters.easing = n.easing || this._parameters.easing || function (n, t, i, r, u) {
                return -r * ((t = t / u - 1) * t * t * t - 1) + i
            };
            this._parameters.duration = n.duration || this._parameters.duration || 1e3;
            this._parameters.callback = n.callback || this._parameters.callback || function () {};
        ...
        _Loader: function () {
            return r ? function (n) {
                ...
                this._heightAdd = t - this._height;
    ...
    r && (Wilq32.PhotoEffect.prototype.createVMLNode = function () {
